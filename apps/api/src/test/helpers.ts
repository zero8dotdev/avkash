...
export async function createMahalaxmiOrg(): Promise<OrgFixture> {
    ...
    .values([
      {
        ...
        laborRegime: 'STANDARD',
        overtimeThresholdHours: '9',
      },
      {
        orgId,
        name: 'Pune MIDC Plant',
        timezone: 'Asia/Kolkata',
      ...
      {
        orgId,
        name: 'Pithampur Plant',
        timezone: 'Asia/Kolkata',
        address: 'SEZ Phase II, Pithampur, MP 454775',
        laborRegime: 'SHOP_ESTABLISHMENT',
        overtimeThresholdHours: '9',
      },
    ])
    ...
    .values([
      {
        ...
        legalName: 'Mahalaxmi Auto Parts Div.',
        brandColor: '1E3A8A',
        createdBy: 'seed',
        updatedBy: 'seed',
      },
      {
        ...
        legalName: 'Mahalaxmi Packtech Div.',
        brandColor: '065F46',
        createdBy: 'seed',
        updatedBy: 'seed',
      },
    ...
    .values([
      {
        ...
        rank: 100,
        isFloating: true,
        requiresPunchConfirmation: false,
        createdBy: 'seed',
        updatedBy: 'seed',
      },
      {
      ...
      },
      {
        ...
        rank: 15,
        isFloating: false,
        requiresPunchConfirmation: true,
        createdBy: 'seed',
        updatedBy: 'seed',
      },
      {
  ...
  const [lvlDir, lvlGm, lvlDgm, lvlMgr, lvlAm, lvlSup, lvlTech, lvlOpr, lvlHlp1, lvlHlp2] = levels as Array<{
    id: string;
  }>;
  ...
  const [tLeadership, tCorporate, tMarketing, tSales, tPuneSup, tPuneW, tNashikW, tSilvassaW, tPithW] = teams as Array<{
    teamId: string;
  }>;
  ...
  const shifts = await db
    ...
    .values([
      ...
      },
      {
        ...
        isFlexible: false,
        trackOvertime: true,
        allowedGenders: ['MALE'], // SEZ: no female night shift
        minStaff: 8,
        createdBy: 'seed',
        updatedBy: 'seed',
      },
  ...
  const elPolicyBase = {
    orgId,
    leaveTypeId: ltEl!.leaveTypeId,
    accruals: true,
    accrualFrequency: 'MONTHLY' as const,
    accrueOn: 'BEGINNING' as const,
    encashable: true,
    isActive: true,
    probationMaxLeaves: null as null | number,
    probationAccruals: null as null | boolean,
    createdBy: 'seed',
    updatedBy: 'seed',
  };
  ...
  return {
    ...
    team: {
      leadership: tLeadership!.teamId,
      corporate: tCorporate!.teamId,
      marketing: tMarketing!.teamId,
      sales: tSales!.teamId,
      puneSup: tPuneSup!.teamId,
      puneWorkers: tPuneW!.teamId,
      nashikWorkers: tNashikW!.teamId,
      silvassaWorkers: tSilvassaW!.teamId,
