import * as server from '../entries/pages/leave/_page.server.ts.js';

export const index = 16;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/leave/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/leave/+page.server.ts";
...
export const stylesheets = ["_app/immutable/assets/ErrorBanner.C1OswYdo.css","_app/immutable/assets/StatusBadge.BXMm2-1m.css","_app/immutable/assets/16.Cb_1wys0.css"];
export const fonts = [];
