...
type LayoutRouteId = RouteId | "/" | "/admin" | "/admin/blackouts" | "/admin/field-policies" | "/admin/holidays" | "/admin/leave-types" | "/admin/workweek-patterns" | "/attendance" | "/comp-off" | "/dashboard" | "/demo" | "/employees" | "/employees/[id]" | "/leave" | "/login" | "/reports" | "/transfers" | null
