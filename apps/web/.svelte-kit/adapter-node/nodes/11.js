import * as server from '../entries/pages/comp-off/_page.server.ts.js';

export const index = 11;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/comp-off/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/comp-off/+page.server.ts";
...
export const stylesheets = ["_app/immutable/assets/ErrorBanner.C1OswYdo.css","_app/immutable/assets/StatusBadge.BXMm2-1m.css","_app/immutable/assets/11.Bv2Xtc8o.css"];
export const fonts = [];
