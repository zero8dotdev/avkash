...
const privacyPolicy = [
  ...
  return (
    <main className="flex min-h-screen flex-col items-start justify-between py-24 text-gray-800 max-w-screen-xl mx-auto px-6">
        <h1 className='font-semibold text-2xl self-center mb-6'>Privacy Policy Of Invoices</h1>
        <h2 className='font-semibold text-xl mb-6'>What personal data we collect and why we collect it </h2>
