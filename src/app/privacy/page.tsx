    ...
    <div className="bg-white ">
      <main className="flex min-h-screen flex-col items-start justify-between py-24 text-gray-800w-full  lg:max-w-[50%] mx-auto px-6 ">
        <h1 className="font-semibold text-2xl md:text-4xl self-center mb-6">
          Privacy Policy Of Avkash
        </h1>
        <div className="space-y-3 mb-4">
          <h2 className="text-2xl font-bold my-2">Who we are</h2>
          <p className="text-xl">
            <span className="font-bold my-2">Our website address is:</span>
            ...
            <span className="my-2 text-[1rem]">
              For any questions, please contact support at support@avkash.io
            </span>
          </p>
        </div>
        <h2 className="font-semibold text-2xl mb-6 mt-2">
