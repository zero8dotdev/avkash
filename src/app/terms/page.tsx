      ...
      <main className="flex min-h-screen flex-col items-start justify-between py-24 text-gray-800w-full  lg:max-w-[50%] mx-auto px-6 ">
        ...
        <p className="mb-6 font-mono text-gray-700">
          <b>
            ...
            USING ANY PART OF OUR WEBSITE OR USING OUR SERVICES, YOU AGREE TO BE
            BOUND BY THIS DOCUMENT. IF YOU DO NOT AGREE TO ALL OF THESE TERMS
            AND CONDITIONS, DO NOT USE OUR WEBSITE OR OTHER PRODUCTS OR SERVICES
            RELATED TO IT.
          </b>
        </p>
