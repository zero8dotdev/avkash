...
export default async function handleBlockActions(
  ...
  switch (actionId) {
    ...
    case 'owner_select_team':
      const ownerSelectedTeamId =
        view.state.values.owner_team_block.owner_select_team.selected_option
          .value;
