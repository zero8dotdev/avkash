            ...
            {table.map((row, index) => {
              return (
                <tr key={index} className="border-b border-gray-200">
                  <th
                    scope="row"
                    className="px-6 py-4 font-medium whitespace-nowrap bg-gray-50 text-gray-700"
                  >
                    {row.aspect}
                  </th>
                  <td className="px-6 py-4 bg-gray-50">{row.withAvkash}</td>
                  <td className="px-6 py-4 bg-gray-50">{row.withoutAvkash}</td>
                </tr>
              );
            })}
          </tbody>
